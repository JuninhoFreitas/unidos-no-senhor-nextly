...
const Hero = () => {
  return (
    <>
    {/* TODO: Arrumar o preenchimento do bg */}
      <Container className="flex flex-col justify-center items-center bg-background-hero bg-no-repeat">
        <div className="flex items-center w-full lg:w-1/2">
          <div className="max-w-2xl mb-8">
            <h1 className="text-4xl font-bold leading-snug tracking-tight text-white lg:text-4xl lg:leading-tight xl:text-6xl xl:leading-tight dark:text-white">
              IGREJA BÍBLICA UNIDOS NO SENHOR
            </h1>
            <p className="py-5 text-xl leading-normal text-white lg:text-xl xl:text-2xl dark:text-gray-300">
              Amando a Deus e as pessoas
            </p>
            <p className="text-xl leading-normal text-white lg:text-xl xl:text-2xl dark:text-gray-300">
        ...
        <div className="flex w-full lg:w-1/2">
          <div className="relative flex flex-col">
            {/* create 4 blocks with solid background to show some texts displaying informations */}
            <div className="flex w-max mx-2 ">
              <div
                id="square-culto-aos-domingos"
                className="flex flex-col justify-center items-center w-full h-40 mx-1 my-1 bg-green-600 square-full shadow-xl"
              >
                <p className="text-2xl leading-6 font-bold text-white mx-28 lg:text-xl xl:text-2xl shadow-lg line-clamp-3 break-words">
                  CULTOS AOS DOMINGOS
                </p>
                <p className="text-2xl leading-normal font-medium mx-28 mt-5 text-black backdrop-blur-0 lg:text-xl xl:text-4xl dark:text-gray-300">
                  19h
                </p>
              </div>
            </div>
            <div className="flex flex-row ml-2">
              <div className="flex flex-col justify-between square-sub-agendas mx-1 my-1 bg-green-600 square-full">
                <p className="ml-1 text-xl leading-6 font-bold text-white lg:text-xl xl:text-2xl shadow-lg line-clamp-3 break-words">
                  Unidos Jovem
                </p>
                <p className="ml-1 text-lg leading-normal font-medium mb-2 text-black backdrop-blur-0 lg:text-xl xl:text-sm dark:text-gray-300">
                  Temas baseados no cotidiano à luz das Escrituras são debatidos com jovens,
                  sábados 19:00
                </p>
              </div>
              <div className="flex flex-col justify-between square-sub-agendas mx-1 my-1 ml-1 bg-green-600 square-full">
                {/* Título */}
                <p className="ml-1 text-xl leading-6 font-bold text-white lg:text-xl xl:text-2xl shadow-lg line-clamp-3 break-words">
                  Grupos nas Casas
                </p>
                {/* Subtexto */}
                <p className="ml-1 text-lg leading-normal font-medium mb-2 text-black backdrop-blur-0 lg:text-xl xl:text-sm dark:text-gray-300">
                  Durante a semana, os encontros são nas casas. Procure um
                  líder.
                </p>
              </div>
              <div className="flex flex-col justify-between square-sub-agendas mx-1 my-1 ml-1 bg-green-600 square-full">
                ...
                {/* Subtexto */}
                <p className="ml-1 text-lg leading-normal font-medium mb-2 text-black backdrop-blur-0 lg:text-xl xl:text-sm dark:text-gray-300">
                Uma oportunidade para Juniores conhecerem a Palavra de Deus. Sábados 16:00
                </p>
              </div>
            </div>
          </div>
